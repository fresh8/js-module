...
describe('src/index.js', () => {
  describe('PollyfillHistoryPushState', () => {
    describe('restore', () => {
      it('Should remove the custome event on restore', () => {
        ...
        window.addEventListener('__f8-creative-script-loaded', eventSpy);
    ...
    describe('fill', () => {
      it('Should add a custome event when the history pushState method is called', done => {
        const pollyfillHistoryPushState = PollyfillHistoryPushState();
        pollyfillHistoryPushState.fill();
        const eventSpy = sinon.spy();
